    ...
    <table class="mx-auto table-auto rounded-md border-separate border border-blue-400 bg-blue mb-12">
      <thead>
        <tr class="bg-blue-400 text-left text-white">
          ...
          <th class="hidden lg:table-cell text-center px-2 truncate">
            <div>Form</div>
            <div>Factor</div>
          </th>
        </tr>
      ...
      <tbody>
        ...
        >
          ...
          <td class="hidden lg:table-cell text-right border-t border-blue-400 px-2 truncate" v-text="item.specs['Form Factor']" />
        </tr>
      </tbody>
    </table>
    <Footnotes />
